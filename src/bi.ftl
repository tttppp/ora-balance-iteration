...
briefing =
    ...
    - Custom BI 4.6 balance:
      ...
      • Queue Limits - Max 5 of each Building/Defence, 100 of each Infantry, 20 of each Vehicle/Air/Naval (all down from 999)
